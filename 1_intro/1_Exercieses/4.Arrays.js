...
friends.push({Brother : 'Alex'});
friends.push({Sister : 'Stephanie'});
friends.push({Mother : 'Susanne'});
...
console.log(dinnerTray.toString());

const dinnerTray1 = [...diet];
console.log(dinnerTray1.toString());
...
console.log(discardedNumbers.toString());
console.log(numbers);
